...
const CryptoDetail = ({ route, navigation }) => {
    ...
    const [selectOption, setSelectOption] = React.useState(chartOptions[0])
        ...
        return (
            ...
            >
                ...
                >
                    ...
                    <View>
                        <Text style={{ ...FONTS.h3}} >R$ {selectedCurrency?.amount}</Text>
                        <Text style={{ color: selectedCurrency?.type == "I" ? COLORS.green : COLORS.red, ...FONTS.body3 }} >R$ { selectedCurrency?.changes }</Text>
                    </View>
                ...
                {/** Options */}
                <View
                    style={{ width: "100%", flexDirection: 'row', paddingHorizontal: SIZES.padding, justifyContent: 'space-between'}}
                >
                        ...
                        return (
                            <TextButton
                                ...
                                customContainerStyle={{
                                    ...
                                    width: 60,
                                    borderRadius: 15,
                                    backgroundColor: selectOption.id == option.id ? COLORS.primary : COLORS.lightGray
                                }}
                                custonLabelStyle={{
                                    color: selectOption.id == option.id ? COLORS.white : COLORS.gray, ...FONTS.body5
                                }}
    ...
    return (
        ...
        <SafeAreaView
            style={{
                ...
                //Codigo abaixo é um hack para android.
